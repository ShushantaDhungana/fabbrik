...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  try {
    ...
    // $query = mysqli_query($conn, "INSERT INTO products (`product_name`, `product_image`, `product_description`, `product_price`, `product_stock`) values ('" . mysqli_real_escape_string($conn, $product_name) . "', '$product_image', '" . mysqli_real_escape_string($conn, $product_description) . "', '$product_price', '$product_stock' )");
...
<head>
  ...
  <title>FABBRICK | Add new product</title>
