...
?>
<?php
$fname_err = $lname_err = $email_err = $email_err1 = $phone_err = $phone_err1 = $pass_err = $pass_err1 =$success = null;
if(isset($_POST['submit'])){
    ...
    if($numExistRows > 0){
        ...
        $sql = "INSERT INTO `register` (`fname`, `lname`, `email`, `phone`, `password`) VALUES ('$fname', '$lname', '$email', '$phone', '$pass')";
